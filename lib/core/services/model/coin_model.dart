...
List<Btc> btcFromJson(List<dynamic> str) => List<Btc>.from(str.map((x) => Btc.fromJson(x)));

String btcToJson(List<Btc> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
